...
const WorkoutTracker: React.FC<WorkoutTrackerProps> = ({ workout, onComplete, onError }) => {
  ...
  const completeSet = () => {
    ...
    if (currentSet < currentExercise.sets) {
      ...
      completeExercise(workout.id, currentExercise.id);
      ...
      if (currentExerciseIndex < workout.exercises.length - 1) {
        ...
        if (!success && onError) {
          onError('Failed to complete exercise. Please try again.');
          setHasError(true);
          return;
        }
        updateWorkout(workout.id, { completed: true, duration });
        ...
        <div className="bg-gray-700/50 rounded-lg p-6 mb-6">
          ...
          <div className="flex space-x-4">
            ...
            >
              ...
              <span>{hasError ? 'Error - Retry' : 'Complete Set'}</span>
            </button>
