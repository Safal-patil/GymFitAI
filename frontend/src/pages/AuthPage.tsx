      ...
      <div className="max-w-md w-full space-y-8">
        ...
        >
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full py-3 px-4 border border-gray-700 rounded-lg font-semibold text-white hover:bg-gray-800 transition-all duration-300 flex items-center justify-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed"
          >
